...
import type { ProteinCount } from './types'
import { useNetworkSidebar } from './NetworkSidebarContext'
import ProteinComparisonModal from './ProteinComparisonModal'
...
export default function NetworkSidebar() {
  ...
  const renderProteinItem = ({ protein, count, type_counts, type_ratios, ratio, other_components }: ProteinCount) => {
